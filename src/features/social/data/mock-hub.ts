...
export const feedEvents: FeedEvent[] = [
  {
    ...
    actor: { name: "Lena Voss", handle: "lenavoss", authorityScore: 94 },
    target: { name: "Marcus Chen", handle: "marcuscuts", authorityScore: 87 },
  ...
  },
  {
    ...
    actor: { name: "Ava Rodriguez", handle: "avaframes", authorityScore: 92 },
    target: { name: "Marcus Chen", handle: "marcuscuts", authorityScore: 87 },
  ...
  },
  {
    ...
    actor: { name: "Jordan Kale", handle: "jkale.edit", authorityScore: 78 },
    target: { name: "Suki Tanaka", handle: "sukicuts", authorityScore: 85 },
  ...
  },
  {
    ...
    actor: { name: "Dante Morales", handle: "dantevfx", authorityScore: 71 },
  ...
  },
  {
    ...
    actor: { name: "Suki Tanaka", handle: "sukicuts", authorityScore: 85 },
    target: { name: "Ava Rodriguez", handle: "avaframes", authorityScore: 92 },
  ...
  },
  {
    ...
    actor: { name: "Kai Nakamura", handle: "kaiframes", authorityScore: 32 },
  ...
  },
  {
    ...
    actor: { name: "Marcus Chen", handle: "marcuscuts", authorityScore: 87 },
    target: { name: "Dante Morales", handle: "dantevfx", authorityScore: 71 },
